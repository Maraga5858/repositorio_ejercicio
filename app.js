...
const App = {
  data() {
    return {
      productos: [
        { id: 1, nombre: "Mancuernas", precio: 20, imagen: "img/horario.png", cantidadDeseada: 1 },
        { id: 2, nombre: "Cinta de correr", precio: 300, imagen: "img/horario.png", cantidadDeseada: 1 },
        { id: 3, nombre: "Bicicleta estática", precio: 150, imagen: "img/horario.png", cantidadDeseada: 1 },
        { id: 4, nombre: "Pesas rusas", precio: 25, imagen: "img/horario.png", cantidadDeseada: 1 },
        { id: 5, nombre: "Esterilla", precio: 10, imagen: "img/horario.png", cantidadDeseada: 1 },
        { id: 6, nombre: "Banco de pesas", precio: 100, imagen: "img/horario.png", cantidadDeseada: 1 },
      ],
      carrito: [],
      tasaCambio: 1,
